...
ECHO sidechain uses SPV mechanism for storing sidechain transactions. An SPV operations store transaction (transaction receipt for Ethereum) and an appropriate proof. This scheme verifies correctness of sidechain transaction and save integrity of chain.
