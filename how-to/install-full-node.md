...
1. Download the Echo node binary: [echo-linux.0.13.8.tar](https://d14s13k07yt1gw.cloudfront.net/echo-linux.0.13.8.tar)

   ```bash
   wget https://d14s13k07yt1gw.cloudfront.net/echo-linux.0.13.8.tar
   ```

2. Unzip the binary:

   ```bash
   tar -xvf echo-linux.0.13.8.tar
   cd echo-linux.0.13.8
   ```

### Mac OS

1. Download the Echo node binary: [echo-mac.0.13.8.tar](https://d14s13k07yt1gw.cloudfront.net/echo-mac.0.13.8.tar)

   ```bash
   wget https://d14s13k07yt1gw.cloudfront.net/echo-mac.0.13.8.tar
   ```

2. Unzip the binary:

   ```bash
   tar -xvf echo-mac.0.13.8.tar
   cd echo-mac.0.13.8
   ```
