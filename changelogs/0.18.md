...
- Removed unused fields from bitassets:
    - Field `core_exchange_rate` to `asset_bitasset_data_object`.
...
- Fee base to testRPC for [contract_create_operation](../api-reference/echo-operations/contracts.md#contract_create_operation) and [contract_call_operation](../api-reference/echo-operations/contracts.md#contract_call_operation).
- Default number of accounts in testRPC - 10.
- Support [contract_internal_call_operation](../api-reference/echo-operations/contracts.md#contract_internal_call_operation) for x86_64 contracts.
...
- Added some placeholders accounts testRPC.
