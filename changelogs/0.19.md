...
- Wallet API methods:
    ...
    - [get_vc_keywords](../api-reference/echo-wallet-api/README.md#get_vc_keywords)
    ...
    - [get_key_by_id_string](../api-reference/echo-wallet-api/README.md#get_key_by_id_string-id_string)
