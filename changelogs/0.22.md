...
- Wallet API methods:
    ...
    * [create_btc_stake_address](../api-reference/echo-wallet-api/README.md#create_btc_stake_address-account-user_pubkey-broadcast);
    * [get_btc_stake_address](../api-reference/echo-wallet-api/README.md#get_btc_stake_address-account);
- Database API method: 
    ...
    * [get_btc_stake_address](../api-reference/echo-node-api/database-api/sidechain-api.md#get_btc_stake_address-account);
...
- Operation [sidechain_btc_create_stake_script_operation](../api-reference/echo-operations/sidechain.md#sidechain_btc_create_stake_script_operation).
- Object `btc_stake_script_object`.
...
- Removed [sidechain_btc_block_process_operation](../api-reference/echo-operations/sidechain.md#sidechain_btc_block_process_operation).
...
FC_REFLECT_DERIVED(echo::chain::btc_stake_script_object,
                  (echo::chain::object),
                  (account)(stake_script)(p2sh_address)(extensions))

FC_REFLECT_ENUM( echo::chain::object_type,
                 (null_object_type)
                 (base_object_type)
                 (account_object_type)
                 (asset_object_type)
                 ...
                 (eth_deposit_object_type)
                 (eth_withdraw_object_type)
                 (erc20_token_object_type)
                 (erc20_deposit_token_object_type)
                 (erc20_withdraw_token_object_type)
                 ...
                 (btc_stake_script_object_type)
                 (evm_address_object_type)
                 (did_object_type)
                 (OBJECT_TYPE_COUNT)
               )

FC_REFLECT(echo::chain::sidechain_btc_create_stake_script_operation,
...
- Wallet API methods: [transfer_to_address](../api-reference/echo-wallet-api/README.md#transfer_to_address-from-address-amount-asset_symbol-broadcast), [create_vesting_linear_policy](../api-reference/echo-wallet-api/README.md#create_vesting_linear_policy-creator_name-owner_name-amount-asset_symbol-vesting_cliff_seconds-vesting_duration-second-broadcast), [create_vesting_cdd_policy](../api-reference/echo-wallet-api/README.md#create_vesting_cdd_policy-creator_name-owner_name-amount-asset_symbol-vesting_second-broadcast).
