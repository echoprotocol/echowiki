...
- Database API
    ...
    - Remove `get_contract_logs`. Rename `get_contract_logs2` to [get_contract_logs](/api-reference/echo-node-api/database-api.md#get_contract_logs-contract_logs_filter_options)
